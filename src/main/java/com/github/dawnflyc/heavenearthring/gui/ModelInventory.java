...
public class ModelInventory implements IInventory, IRecipeHelperPopulator {

    protected final int slotsCount;
    protected final NonNullList<ItemStack> inventoryContents;
    protected List<IInventoryChangedListener> listeners;

    public ModelInventory(int numSlots) {
        this.slotsCount = numSlots;
        this.inventoryContents = NonNullList.withSize(numSlots, ItemStack.EMPTY);
    }

    public ModelInventory(ItemStack... stacksIn) {
        this.slotsCount = stacksIn.length;
        this.inventoryContents = NonNullList.from(ItemStack.EMPTY, stacksIn);
    }

    public ModelInventory(NonNullList<ItemStack> stacksIn) {
        this.slotsCount = stacksIn.size();
